...
#define  MF522_NSS_H  P4OUT |= BIT0			//RC500片选 SDA
#define  MF522_NSS_L  P4OUT &= ~BIT0
#define  MF522_SCK_H  P4OUT |= BIT1
#define  MF522_SCK_L  P4OUT &= ~BIT1
#define  MF522_SI_H  P4OUT |= BIT2				//MOSI  写数据   设置为输入引脚
#define  MF522_SI_L  P4OUT &= ~BIT2

#define  MF522_SO    P4IN & BIT3				//miso  读数据
#define  MF522_RST_H P1OUT |= BIT2
#define  MF522_RST_L P1OUT &= ~BIT2
#define MAXRLEN 18
unsigned char g_ucTempbuf[20];  //刷卡读出来的信息
/////////////////////////////////////////////////////////////////////
//函数原型
/////////////////////////////////////////////////////////////////////
